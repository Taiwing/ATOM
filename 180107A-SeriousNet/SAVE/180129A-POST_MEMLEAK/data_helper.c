...
{
  if(!ft_strcmp(name, "handy") || !ft_strcmp(name, "handy_s"))
    get_MNIST_data_set(training_data, test_data);
  else if(!ft_strcmp(name, "test"))
    get_TEST_data_set(training_data, test_data, train_s, test_s);
  else if(!ft_strcmp(name, "test2"))
    get_TEST_data_set(training_data, test_data, train_s, test_s);
