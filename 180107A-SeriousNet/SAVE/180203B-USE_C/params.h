...
**  -e: --exception (defines individual values for th sizes array) [FIND ANOTHER LETTER FOR THIS OPTION]
...
**  -u: --use (simply feeds the network whith chosen or random data) (make it possible to load data from a file or the command line)
