...
/*   Updated: 2018/12/13 19:13:39 by yforeau          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	testls_02(void)
{
	...
	setlocale(LC_ALL, "");
	printf("Test_S => 02\n");
	ret1 = printf("orig : %45ls\n", L"chewing gum🤗 🤗 🤗 🤗\0");
	ret2 = ft_printf("cust : %45ls\n", L"chewing gum🤗 🤗 🤗 🤗\0");
	printf("\n");
	printf("ret_orig : %d\n", ret1);
	printf("ret_cust : %d\n", ret2);
	printf("\n");
...
void	testls_03(void)
{
	...
	setlocale(LC_ALL, "");
	printf("Test_S => 03\n");
	ret1 = printf("orig : %5ls\n", L"🤗");
	ret2 = ft_printf("cust : %5ls\n", L"🤗");
	printf("\n");
	printf("ret_orig : %d\n", ret1);
	printf("ret_cust : %d\n", ret2);
	printf("\n");
...
void	testls_09(void)
{
	...
	setlocale(LC_ALL, "");
	printf("Test_S => 09\n");
	ret1 = printf("orig : %2ls\n", L"🤗🤗🤗🤗");
	ret2 = ft_printf("cust : %2ls\n", L"🤗🤗🤗🤗");
	printf("\n");
	printf("ret_orig : %d\n", ret1);
	printf("ret_cust : %d\n", ret2);
	printf("\n");
...
void	testls_10(void)
{
	...
	setlocale(LC_ALL, "");
	printf("Test_S => 10\n");
	ret1 = printf("orig : %15ls\n", NULL);
	ret2 = ft_printf("cust : %15ls\n", NULL);
	printf("\n");
	printf("ret_orig : %d\n", ret1);
	printf("ret_cust : %d\n", ret2);
	printf("\n");
...
void	testls_11(void)
{
	...
	setlocale(LC_ALL, "");
	printf("Test_S => 11\n");
	ret1 = printf("orig : %.3ls\n", NULL);
	ret2 = ft_printf("cust : %.3ls\n", NULL);
	printf("\n");
	printf("ret_orig : %d\n", ret1);
	printf("ret_cust : %d\n", ret2);
	printf("\n");
...
void	testls_12(void)
{
	...
	setlocale(LC_ALL, "");
	printf("Test_S => 12\n");
	ret1 = printf("orig : %.10ls\n", L"Valgrind ©©©©");
	ret2 = ft_printf("cust : %.10ls\n", L"Valgrind ©©©©");
	printf("\n");
	printf("ret_orig : %d\n", ret1);
	printf("ret_cust : %d\n", ret2);
	printf("\n");
...
void	testls_14(void)
{
	...
	setlocale(LC_ALL, "");
	printf("Test_S => 14\n");
	ret1 = printf("orig : %.11ls\n", L"Valgrind ©©©©");
	ret2 = ft_printf("cust : %.11ls\n", L"Valgrind ©©©©");
	printf("\n");
	printf("ret_orig : %d\n", ret1);
	printf("ret_cust : %d\n", ret2);
	printf("\n");
...
void	testls_15(void)
{
	...
	setlocale(LC_ALL, "");
	printf("Test_S => 15\n");
	ret1 = printf("orig : %.12ls\n", L"Valgrind ©©©©");
	ret2 = ft_printf("cust : %.12ls\n", L"Valgrind ©©©©");
	printf("\n");
	printf("ret_orig : %d\n", ret1);
	printf("ret_cust : %d\n", ret2);
	printf("\n");
...
void	testls_17(void)
{
	...
	setlocale(LC_ALL, "");
	printf("Test_S => 17\n");
	ret1 = printf("orig : %ls, %ls\n", L"暖炉", L"لحم خنزير");
	ret2 = ft_printf("cust : %ls, %ls\n", L"暖炉", L"لحم خنزير");
	printf("\n");
	printf("ret_orig : %d\n", ret1);
	printf("ret_cust : %d\n", ret2);
	printf("\n");
...
void	testls_18(void)
{
	...
	setlocale(LC_ALL, "");
	printf("Test_S => 18\n");
	ret1 = printf("orig : %030ls\n", L"©©©");
	ret2 = ft_printf("cust : %030ls\n", L"©©©");
	printf("\n");
	printf("ret_orig : %d\n", ret1);
	printf("ret_cust : %d\n", ret2);
	printf("\n");
...
void	testls_19(void)
{
	...
	setlocale(LC_ALL, "");
	printf("Test_S => 19\n");
	ret1 = printf("orig : {%05.ls}\n", L"42 c est cool");
	ret2 = ft_printf("cust : {%05.ls}\n", L"42 c est cool");
	printf("\n");
	printf("ret_orig : %d\n", ret1);
	printf("ret_cust : %d\n", ret2);
	printf("\n");
...
void	testls_20(void)
{
	...
	setlocale(LC_ALL, "");
	printf("Test_S => 20\n");
	ret1 = printf("orig : {%.22ls}\n", L"🤗🤗🤗🤗🤗©©");
	ret2 = ft_printf("cust : {%.22ls}\n", L"🤗🤗🤗🤗🤗©©");
	printf("\n");
	printf("ret_orig : %d\n", ret1);
	printf("ret_cust : %d\n", ret2);
	printf("\n");
