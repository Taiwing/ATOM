...
packSons *chargerSon()
{
  ...
  sons->themeSample = al_load_sample("media_files/sons/TetrisTheme.ogg");
  sons->gamestartSample = al_load_sample("media_files/sons/SFX_GameStart.ogg");
  sons->gameoverSample = al_load_sample("media_files/sons/SFX_GameOver.ogg");
  sons->levelupSample = al_load_sample("media_files/sons/SFX_LevelUp.ogg");
  sons->fallSample = al_load_sample("media_files/sons/SFX_PieceFall.ogg");
  sons->harddropSample = al_load_sample("media_files/sons/SFX_PieceHardDrop.ogg");
  sons->holdSample = al_load_sample("media_files/sons/SFX_PieceHold.ogg");
  sons->lockedSample = al_load_sample("media_files/sons/SFX_PieceLockdown.ogg");
  sons->movelrSample = al_load_sample("media_files/sons/SFX_PieceMoveLR.ogg");
  sons->rotatefailSample = al_load_sample("media_files/sons/SFX_PieceRotateFail.ogg");
  sons->rotatelrSample = al_load_sample("media_files/sons/SFX_PieceRotateLR.ogg");
  sons->softdropSample = al_load_sample("media_files/sons/SFX_PieceSoftDrop.ogg");
  sons->touchdownSample = al_load_sample("media_files/sons/SFX_PieceTouchDown.ogg");
  sons->touchlrSample = al_load_sample("media_files/sons/SFX_PieceTouchLR.ogg");
  sons->lcsingleSample = al_load_sample("media_files/sons/SFX_SpecialLineClearSingle.ogg");
  sons->lcdoubleSample = al_load_sample("media_files/sons/SFX_SpecialLineClearDouble.ogg");
  sons->lctripleSample = al_load_sample("media_files/sons/SFX_SpecialLineClearTriple.ogg");
  sons->lctetrisSample = al_load_sample("media_files/sons/SFX_SpecialTetris.ogg");
  sons->stspinSample = al_load_sample("media_files/sons/SFX_SpecialTSpin.ogg");
  sons->stspinsingleSample = al_load_sample("media_files/sons/SFX_SpecialTSpinSingle.ogg");
  sons->stspindoubleSample = al_load_sample("media_files/sons/SFX_SpecialTSpinDouble.ogg");
  sons->stspintripleSample = al_load_sample("media_files/sons/SFX_SpecialTSpinTriple.ogg");
...
void jouerSon(soundConfig *sound, packSons *sons, int gameEvent, bool modifVolume)
{
  if(sound->soundOnOff[SOUND] && sound->soundOnOff[FX]) //si le son est activé
  {
    switch(gameEvent)
    {
      case GAMESTART:
