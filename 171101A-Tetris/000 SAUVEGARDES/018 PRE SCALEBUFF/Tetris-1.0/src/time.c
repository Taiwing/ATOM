...
{
  regenererPackImages(images, elem, PISTLINPUT, SPRINT, screen->buffer, NULL, temps, screen->buffW, screen->buffH); //on régénère le packSTLInput pour avoir la bonne image
