...
{
  regenererPackImages(images, elem, PISTLINPUT, ULTRA, screen->buffer, NULL, lignes, screen->buffW, screen->buffH); //on régénère le packSTLInput pour avoir la bonne image
