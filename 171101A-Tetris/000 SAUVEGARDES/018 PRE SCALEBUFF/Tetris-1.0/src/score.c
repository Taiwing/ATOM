...
{
  regenererPackImages(images, elem, PISTLINPUT, MARATHON, screen->buffer, NULL, score, screen->buffW, screen->buffH); //on régénère le packSTLInput pour avoir la bonne image
