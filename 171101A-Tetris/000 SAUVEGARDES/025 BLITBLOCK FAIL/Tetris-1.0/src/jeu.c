...
gameData *initialiserGameData(int niveauChoisi)
{
  ...
  //variables du buffer de la grille
  for(int i = 0; i < 4; i++)
  {
    data->dispLines[i] = 0;
  }
  data->actualizeGridBuffer = false;
...
int enleverLignes(gameData *data)
{
  ...
  //on vide le tableau qui va stocker la valeur y des lignes complétées
  for(int i = 0; i < 4; i++)
  {
    data->dispLines[i] = 0;
  }
  ...
  for(int y = 2; y < GRID_H; y++)
  {
    for(int x = 0; x < GRID_W; x++)
    {
      ...
      if(x == 9) //quand on a fini la ligne
      {
        ...
        {
          nbLignesCompletes++;
          data->dispLines[nbLignesCompletes - 1] = y;
  ...
  data->actualizeGridBuffer = true; //on dit à la fonction d'affichage qu'il faut mettre à jour le buffer
...
void afficherPartie(gameScreen *screen, packPartie *images, elements *elem, gameData *data, int modeDeJeu, int timer)
{
  ...
  if(data->actualizeGridBuffer) //si des lignes ont été enlevées de la grille
  {
    actualizeBuffingGrid(images->buffingGrid, data->dispLines, screen, images);
    data->actualizeGridBuffer = false;
  }
      ...
      switch(data->grille[x][y]) //on regarde la valeur stockée dans la case
      {
        case JAUNE:
          if(data->animDisp && lignesDisp[y] && x == 0) //si cette ligne doit disparaître
            al_draw_bitmap_region(images->ligneBlanche, 0, 0, 31 * scale, 31 * scale, pos[X] - (3 * scale), pos[Y] - (3 * scale), 0);
        ...
        case JAUNE_G:
          if(data->animDisp && lignesDisp[y] && x == 0) //si cette ligne doit disparaître
            ...
            blitBlock(JAUNE, screen, images, &images->buffingGrid[x][y], pos[X], pos[Y]);
          switch(y)
          {
            case 2: //si on est sur une case en haut de la grille
              dessinerBarreHaute = true;
        ...
        case CYAN_G:
          if(data->animDisp && lignesDisp[y] && x == 0) //si cette ligne doit disparaître
            ...
            blitBlock(CYAN, screen, images, &images->buffingGrid[x][y], pos[X], pos[Y]);
          switch(y)
          {
            case 2: //si on est sur une case en haut de la grille
              dessinerBarreHaute = true;
        ...
        case MAUVE_G:
          if(data->animDisp && lignesDisp[y] && x == 0) //si cette ligne doit disparaître
            ...
            blitBlock(MAUVE, screen, images, &images->buffingGrid[x][y], pos[X], pos[Y]);
          switch(y)
          {
            case 2: //si on est sur une case en haut de la grille
              dessinerBarreHaute = true;
        ...
        case VIOLET_G:
          if(data->animDisp && lignesDisp[y] && x == 0) //si cette ligne doit disparaître
            ...
            blitBlock(VIOLET, screen, images, &images->buffingGrid[x][y], pos[X], pos[Y]);
          switch(y)
          {
            case 2: //si on est sur une case en haut de la grille
              dessinerBarreHaute = true;
        ...
        case ORANGE_G:
          if(data->animDisp && lignesDisp[y] && x == 0) //si cette ligne doit disparaître
            ...
            blitBlock(ORANGE, screen, images, &images->buffingGrid[x][y], pos[X], pos[Y]);
          switch(y)
          {
            case 2: //si on est sur une case en haut de la grille
              dessinerBarreHaute = true;
        ...
        case VERT_G:
          if(data->animDisp && lignesDisp[y] && x == 0) //si cette ligne doit disparaître
            ...
            blitBlock(VERT, screen, images, &images->buffingGrid[x][y], pos[X], pos[Y]);
          switch(y)
          {
            case 2: //si on est sur une case en haut de la grille
              dessinerBarreHaute = true;
        ...
        case ROUGE_G:
          if(data->animDisp && lignesDisp[y] && x == 0) //si cette ligne doit disparaître
            ...
            blitBlock(ROUGE, screen, images, &images->buffingGrid[x][y], pos[X], pos[Y]);
          switch(y)
          {
            case 2: //si on est sur une case en haut de la grille
              dessinerBarreHaute = true;
