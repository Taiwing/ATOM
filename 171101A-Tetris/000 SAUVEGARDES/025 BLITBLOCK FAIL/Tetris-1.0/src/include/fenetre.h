...
void changeRes(gameScreen *screen, elements *elem, packImages *images, gameConfig *config); //va appliquer le changement de résolution en redessinant les images du jeu à l'échelle
...
//va dessiner les blocks sur les buffers
