...
elements *genererElements()
{
  ...
  //rectAide
  elem->rectAide->x = 104; //coordonnée x du point d'origine
  elem->rectAide->y = 53; //coordonnée y du point d'origine
  elem->rectAide->x2 = 347; //coordonnée x du point de fin
  elem->rectAide->y2 = 548; //coordonnée y du point de fin
  ...
  //rectOptions
  elem->rectOptions->x = 48; //coordonnée x du point d'origine
  elem->rectOptions->y = 3; //coordonnée y du point d'origine
  elem->rectOptions->x2 = 403; //coordonnée x du point de fin
  elem->rectOptions->y2 = 598; //coordonnée y du point de fin
  ...
  //rectSTLInput
  elem->rectSTLInput->x = 96; //coordonnée x du point d'origine
  elem->rectSTLInput->y = 135; //coordonnée y du point d'origine
  elem->rectSTLInput->x2 = 355; //coordonnée x du point de fin
  elem->rectSTLInput->y2 = 466; //coordonnée y du point de fin
  ...
  //rectBMenuJouer
  elem->rectBMenuJouer->x = 111; //coordonnée x du point d'origine
  elem->rectBMenuJouer->y = 37; //coordonnée y du point d'origine
  elem->rectBMenuJouer->x2 = 341; //coordonnée x du point de fin
  elem->rectBMenuJouer->y2 = 127; //coordonnée y du point de fin
  ...
  //rectBMenuNiveau
  elem->rectBMenuNiveau->x = 126; //coordonnée x du point d'origine
  elem->rectBMenuNiveau->y = 207; //coordonnée y du point d'origine
  elem->rectBMenuNiveau->x2 = 326; //coordonnée x du point de fin
  elem->rectBMenuNiveau->y2 = 267; //coordonnée y du point de fin
  ...
  //rectBMenuMode
  elem->rectBMenuMode->x = 126; //coordonnée x du point d'origine
  elem->rectBMenuMode->y = 137; //coordonnée y du point d'origine
  elem->rectBMenuMode->x2 = 326; //coordonnée x du point de fin
  elem->rectBMenuMode->y2 = 197; //coordonnée y du point de fin
  ...
  //rectBMenuAide
  elem->rectBMenuAide->x = 126; //coordonnée x du point d'origine
  elem->rectBMenuAide->y = 503; //coordonnée y du point d'origine
  elem->rectBMenuAide->x2 = 221; //coordonnée x du point de fin
  elem->rectBMenuAide->y2 = 563; //coordonnée y du point de fin
  ...
  //rectBMenuOptions
  elem->rectBMenuOptions->x = 231; //coordonnée x du point d'origine
  elem->rectBMenuOptions->y = 503; //coordonnée y du point d'origine
  elem->rectBMenuOptions->x2 = 326; //coordonnée x du point de fin
  elem->rectBMenuOptions->y2 = 563; //coordonnée y du point de fin
  ...
  //rectBAideOk
  elem->rectBAideOk->x = 194; //coordonnée x du point d'origine
  elem->rectBAideOk->y = 475; //coordonnée y du point d'origine
  elem->rectBAideOk->x2 = 257; //coordonnée x du point de fin
  elem->rectBAideOk->y2 = 525; //coordonnée y du point de fin
  ...
  //rectBPauseReprendre
  elem->rectBPauseReprendre->x = 106; //coordonnée x du point d'origine
  elem->rectBPauseReprendre->y = 181; //coordonnée y du point d'origine
  elem->rectBPauseReprendre->x2 = 345; //coordonnée x du point de fin
  elem->rectBPauseReprendre->y2 = 271; //coordonnée y du point de fin
  ...
  //rectBPauseAide
  elem->rectBPauseAide->x = 136; //coordonnée x du point d'origine
  elem->rectBPauseAide->y = 281; //coordonnée y du point d'origine
  elem->rectBPauseAide->x2 = 315; //coordonnée x du point de fin
  elem->rectBPauseAide->y2 = 351; //coordonnée y du point de fin
  ...
  //rectBPauseOptions
  elem->rectBPauseOptions->x = 136; //coordonnée x du point d'origine
  elem->rectBPauseOptions->y = 361; //coordonnée y du point d'origine
  elem->rectBPauseOptions->x2 = 315; //coordonnée x du point de fin
  elem->rectBPauseOptions->y2 = 431; //coordonnée y du point de fin
  ...
  //rectBPauseQuitter
  elem->rectBPauseQuitter->x = 136; //coordonnée x du point d'origine
  elem->rectBPauseQuitter->y = 441; //coordonnée y du point d'origine
  elem->rectBPauseQuitter->x2 = 315; //coordonnée x du point de fin
  elem->rectBPauseQuitter->y2 = 511; //coordonnée y du point de fin
  ...
  elem->rectBOptionsVolThemeM->x = 241; //coordonnée x du point d'origine
  elem->rectBOptionsVolThemeM->y = 343; //coordonnée y du point d'origine
  elem->rectBOptionsVolThemeM->x2 = 281; //coordonnée x du point de fin
  elem->rectBOptionsVolThemeM->y2 = 363; //coordonnée y du point de fin
  ...
  elem->rectBOptionsVolThemeP->x = 352; //coordonnée x du point d'origine
  elem->rectBOptionsVolThemeP->y = 343; //coordonnée y du point d'origine
  elem->rectBOptionsVolThemeP->x2 = 392; //coordonnée x du point de fin
  elem->rectBOptionsVolThemeP->y2 = 363; //coordonnée y du point de fin
  ...
  //rectBOptionsVolFXM
  elem->rectBOptionsVolFXM->x = 241; //coordonnée x du point d'origine
  elem->rectBOptionsVolFXM->y = 383; //coordonnée y du point d'origine
  elem->rectBOptionsVolFXM->x2 = 281; //coordonnée x du point de fin
  elem->rectBOptionsVolFXM->y2 = 403; //coordonnée y du point de fin
  ...
  //rectBOptionsVolFXP
  elem->rectBOptionsVolFXP->x = 352; //coordonnée x du point d'origine
  elem->rectBOptionsVolFXP->y = 383; //coordonnée y du point d'origine
  elem->rectBOptionsVolFXP->x2 = 392; //coordonnée x du point de fin
  elem->rectBOptionsVolFXP->y2 = 403; //coordonnée y du point de fin
  ...
  //rectBOptionsReset
  elem->rectBOptionsReset->x = 134; //coordonnée x du point d'origine
  elem->rectBOptionsReset->y = 433; //coordonnée y du point d'origine
  elem->rectBOptionsReset->x2 = 317; //coordonnée x du point de fin
  elem->rectBOptionsReset->y2 = 483; //coordonnée y du point de fin
  ...
  //rectBOptionsOk
  elem->rectBOptionsOk->x = 194; //coordonnée x du point d'origine
  elem->rectBOptionsOk->y = 508; //coordonnée y du point d'origine
  elem->rectBOptionsOk->x2 = 257; //coordonnée x du point de fin
  elem->rectBOptionsOk->y2 = 558; //coordonnée y du point de fin
  ...
  //rectBSTLOk
  elem->rectBSTLOk->x = 194; //coordonnée x du point d'origine
  elem->rectBSTLOk->y = 385; //coordonnée y du point d'origine
  elem->rectBSTLOk->x2 = 257; //coordonnée x du point de fin
  elem->rectBSTLOk->y2 = 435; //coordonnée y du point de fin
  ...
  //rectIOptionsLeft
  elem->rectIOptionsLeft->x = 241; //coordonnée x du point d'origine
  elem->rectIOptionsLeft->y = 103; //coordonnée y du point d'origine
  elem->rectIOptionsLeft->x2 = 392; //coordonnée x du point de fin
  elem->rectIOptionsLeft->y2 = 123; //coordonnée y du point de fin
  ...
  //rectIOptionsRight
  elem->rectIOptionsRight->x = 241; //coordonnée x du point d'origine
  elem->rectIOptionsRight->y = 128; //coordonnée y du point d'origine
  elem->rectIOptionsRight->x2 = 392; //coordonnée x du point de fin
  elem->rectIOptionsRight->y2 = 148; //coordonnée y du point de fin
  ...
  //rectIOptionsRotatel
  elem->rectIOptionsRotatel->x = 241; //coordonnée x du point d'origine
  elem->rectIOptionsRotatel->y = 153; //coordonnée y du point d'origine
  elem->rectIOptionsRotatel->x2 = 392; //coordonnée x du point de fin
  elem->rectIOptionsRotatel->y2 = 173; //coordonnée y du point de fin
  ...
  //rectIOptionsRotater
  elem->rectIOptionsRotater->x = 241; //coordonnée x du point d'origine
  elem->rectIOptionsRotater->y = 178; //coordonnée y du point d'origine
  elem->rectIOptionsRotater->x2 = 392; //coordonnée x du point de fin
  elem->rectIOptionsRotater->y2 = 198; //coordonnée y du point de fin
  ...
  //rectIOptionsHardd
  elem->rectIOptionsHardd->x = 241; //coordonnée x du point d'origine
  elem->rectIOptionsHardd->y = 203; //coordonnée y du point d'origine
  elem->rectIOptionsHardd->x2 = 392; //coordonnée x du point de fin
  elem->rectIOptionsHardd->y2 = 223; //coordonnée y du point de fin
  ...
  //rectIOptionsSoftd
  elem->rectIOptionsSoftd->x = 241; //coordonnée x du point d'origine
  elem->rectIOptionsSoftd->y = 228; //coordonnée y du point d'origine
  elem->rectIOptionsSoftd->x2 = 392; //coordonnée x du point de fin
  elem->rectIOptionsSoftd->y2 = 248; //coordonnée y du point de fin
  ...
  //rectIOptionsPause
  elem->rectIOptionsPause->x = 241; //coordonnée x du point d'origine
  elem->rectIOptionsPause->y = 253; //coordonnée y du point d'origine
  elem->rectIOptionsPause->x2 = 392; //coordonnée x du point de fin
  elem->rectIOptionsPause->y2 = 273; //coordonnée y du point de fin
  ...
  //rectIOptionsGhost
  elem->rectIOptionsGhost->x = 241; //coordonnée x du point d'origine
  elem->rectIOptionsGhost->y = 278; //coordonnée y du point d'origine
  elem->rectIOptionsGhost->x2 = 392; //coordonnée x du point de fin
  elem->rectIOptionsGhost->y2 = 298; //coordonnée y du point de fin
  ...
  //rectIOptionsChange
  elem->rectIOptionsChange->x = 241; //coordonnée x du point d'origine
  elem->rectIOptionsChange->y = 303; //coordonnée y du point d'origine
  elem->rectIOptionsChange->x2 = 392; //coordonnée x du point de fin
  elem->rectIOptionsChange->y2 = 323; //coordonnée y du point de fin
  ...
  elem->rectIInputOptionsTouche1->x = 241; //coordonnée x du point d'origine
  elem->rectIInputOptionsTouche1->y = 230; //coordonnée y du point d'origine
  elem->rectIInputOptionsTouche1->x2 = 362; //coordonnée x du point de fin
  elem->rectIInputOptionsTouche1->y2 = 250; //coordonnée y du point de fin
  ...
  elem->rectIInputOptionsTouche2->x = 241; //coordonnée x du point d'origine
  elem->rectIInputOptionsTouche2->y = 255; //coordonnée y du point d'origine
  elem->rectIInputOptionsTouche2->x2 = 362; //coordonnée x du point de fin
  elem->rectIInputOptionsTouche2->y2 = 275; //coordonnée y du point de fin
  ...
  elem->rectIInputOptionsTouche3->x = 241; //coordonnée x du point d'origine
  elem->rectIInputOptionsTouche3->y = 280; //coordonnée y du point d'origine
  elem->rectIInputOptionsTouche3->x2 = 362; //coordonnée x du point de fin
  elem->rectIInputOptionsTouche3->y2 = 300; //coordonnée y du point de fin
  ...
  //rectBInputOptionsOk
  elem->rectBInputOptionsOk->x = 194; //coordonnée x du point d'origine
  elem->rectBInputOptionsOk->y = 320; //coordonnée y du point d'origine
  elem->rectBInputOptionsOk->x2 = 257; //coordonnée x du point de fin
  elem->rectBInputOptionsOk->y2 = 370; //coordonnée y du point de fin
  ...
  //rectISTLInput
  elem->rectISTLInput->x = 141; //coordonnée x du point d'origine
  elem->rectISTLInput->y = 315; //coordonnée y du point d'origine
  elem->rectISTLInput->x2 = 310; //coordonnée x du point de fin
  elem->rectISTLInput->y2 = 365; //coordonnée y du point de fin
...
packMenu *genererPackMenu(elements *elem)
{
  ...
  images->fondMenuAide = genererFondMenuAide(elem, true);
  images->boutonOkOff = genererBoutonOk(OFF, elem->rectBAideOk);
  images->boutonOkOn = genererBoutonOk(ON, elem->rectBAideOk);

  return images; //on renvoit le pack d'images
}

ALLEGRO_BITMAP *genererFondMenu(elements *elem)
{
...
ALLEGRO_BITMAP *genererHigh(int modeDeJeu, elements *elem)
{
  ...
  ALLEGRO_COLOR bleuActif = al_map_rgb(104, 120, 166); //couleur de la partie active de la fenêtre
  ALLEGRO_FONT *font = al_load_ttf_font("media_files/Gameplay.ttf", 20, 0);
  ...
  switch(modeDeJeu)
  {
    case MARATHON:
      ...
      font = al_load_ttf_font("media_files/Gameplay.ttf", 17, 0);
...
ALLEGRO_BITMAP *genererBoutonMenu(int typeDeBouton, int onOff, int niveau, elements *elem)
{
  ...
  switch(typeDeBouton)
  {
    case JOUER:
      ...
      font = al_load_ttf_font("media_files/Gameplay.ttf", 45, 0); //on charge la police "Gameplay"
    ...
    case MARATHON:
      ...
      al_set_target_bitmap(bouton); //on cible l'image du bouton pour dessiner dessus
      al_clear_to_color(couleurDeFond); //on remplie par la couleur déterminée au-dessus
      font = al_load_ttf_font("media_files/Gameplay.ttf", 30, 0); //on charge la police "Gameplay"
...
packPartie *genererPackPartie(elements *elem, int modeDeJeu)
{
  //on crée un pointeur vers la structure d'images
  ...
  images->imagesPause->fondMenuAide = genererFondMenuAide(elem, false);
  images->imagesPause->boutonOkOff = genererBoutonOk(OFF, elem->rectBAideOk);
  images->imagesPause->boutonOkOn = genererBoutonOk(ON, elem->rectBAideOk);
...
ALLEGRO_BITMAP *genererFondPartie(elements *elem, int modeDeJeu)
{
...
ALLEGRO_BITMAP *genererFondPause(elements *elem, ALLEGRO_BITMAP *fondPartie)
{
  ...
  rect = elem->rectPause;
  ALLEGRO_FONT *font = al_load_ttf_font("media_files/Gameplay.ttf", 45, 0); //on charge la police "Gameplay"
...
ALLEGRO_BITMAP *genererBoutonPause(int typeDeBouton, int onOff, elements *elem)
{
  //on crée un pointeur vers l'image qu'on va renvoyer
  ALLEGRO_BITMAP *bouton = NULL;
...
ALLEGRO_BITMAP *genererBoutonOk(int onOff, coord *rectOk)
{
  ...
  al_set_target_bitmap(bouton); //on cible l'image du bouton pour dessiner dessus
  al_clear_to_color(couleurDeFond); //on remplie par la couleur déterminée au-dessus
  font = al_load_ttf_font("media_files/Gameplay.ttf", 25, 0); //on charge la police "Gameplay"
...
ALLEGRO_BITMAP *genererFondMenuAide(elements *elem, bool menu)
{
  ...
  if(menu)
  {
    ...
    font = al_load_ttf_font("media_files/Raleway-Bold.ttf", 15, 0); //on charge la police "Gameplay"
...
packScoreInput *genererPackScoreInput(ALLEGRO_BITMAP *fondPrecedent, elements *elem, int score)
{
  packScoreInput *images = malloc(sizeof(packScoreInput));

  images->fond = genererFondScoreInput(fondPrecedent, elem, score);
  images->boutonOkOff = genererBoutonOk(OFF, elem->rectBSTLOk);
  images->boutonOkOn = genererBoutonOk(ON, elem->rectBSTLOk);
...
ALLEGRO_BITMAP *genererFondScoreInput(ALLEGRO_BITMAP *fondPrecedent, elements *elem, int score)
{
  ...
  font = al_load_ttf_font("media_files/Gameplay.ttf", 18, 0); //on charge la police "Gameplay"
...
packOptions *genererPackOptions(elements *elem, ALLEGRO_BITMAP *fondPrecedent, int keyMap[16][3])
{
  //on crée un pointeur vers la structure d'images
...
ALLEGRO_BITMAP *genererFondOptions(elements *elem, ALLEGRO_BITMAP *fondPrecedent, int recharge)
{
  ...
  ALLEGRO_COLOR bleuActif = al_map_rgb(104, 120, 166); //couleur de la partie active de la fenêtre
  ALLEGRO_COLOR bleuFond = al_map_rgb(206, 224, 245); //couleur de fond
  ALLEGRO_FONT *font = al_load_ttf_font("media_files/Raleway-Bold.ttf", 15, 0); //on charge la police "Gameplay"
  ...
  al_draw_filled_rectangle(rect->x + rect->t, rect->y, rect->x2 - rect->t, rect->y + rect->t, bleuActif); //barre horizontale haute
  al_draw_filled_rectangle(rect->x + rect->t, rect->y2 - rect->t, rect->x2 - rect->t, rect->y2, bleuActif); //barre horizontale basse
  al_draw_text(font, bleuActif, elem->rectOptions->x + 11, rect->y, 0, "ROTATION DROITE");
  ...
  al_draw_filled_rectangle(rect->x + rect->t, rect->y, rect->x2 - rect->t, rect->y + rect->t, bleuActif); //barre horizontale haute
  al_draw_filled_rectangle(rect->x + rect->t, rect->y2 - rect->t, rect->x2 - rect->t, rect->y2, bleuActif); //barre horizontale basse
  al_draw_text(font, bleuActif, elem->rectOptions->x + 11, rect->y, 0, "SOFT DROP");
  ...
  al_draw_filled_rectangle(rect->x + rect->t, rect->y, rect->x2 - rect->t, rect->y + rect->t, bleuActif); //barre horizontale haute
  al_draw_filled_rectangle(rect->x + rect->t, rect->y2 - rect->t, rect->x2 - rect->t, rect->y2, bleuActif); //barre horizontale basse
  al_draw_text(font, bleuActif, elem->rectOptions->x + 11, rect->y, 0, "MOUVEMENT GAUCHE");
  ...
  al_draw_filled_rectangle(rect->x + rect->t, rect->y, rect->x2 - rect->t, rect->y + rect->t, bleuActif); //barre horizontale haute
  al_draw_filled_rectangle(rect->x + rect->t, rect->y2 - rect->t, rect->x2 - rect->t, rect->y2, bleuActif); //barre horizontale basse
  al_draw_text(font, bleuActif, elem->rectOptions->x + 11, rect->y, 0, "MOUVEMENT DROITE");
  ...
  al_draw_filled_rectangle(rect->x + rect->t, rect->y, rect->x2 - rect->t, rect->y + rect->t, bleuActif); //barre horizontale haute
  al_draw_filled_rectangle(rect->x + rect->t, rect->y2 - rect->t, rect->x2 - rect->t, rect->y2, bleuActif); //barre horizontale basse
  al_draw_text(font, bleuActif, elem->rectOptions->x + 11, rect->y, 0, "HARD DROP");
  ...
  al_draw_filled_rectangle(rect->x + rect->t, rect->y, rect->x2 - rect->t, rect->y + rect->t, bleuActif); //barre horizontale haute
  al_draw_filled_rectangle(rect->x + rect->t, rect->y2 - rect->t, rect->x2 - rect->t, rect->y2, bleuActif); //barre horizontale basse
  al_draw_text(font, bleuActif, elem->rectOptions->x + 11, rect->y, 0, "ROTATION GAUCHE");
  ...
  al_draw_filled_rectangle(rect->x + rect->t, rect->y, rect->x2 - rect->t, rect->y + rect->t, bleuActif); //barre horizontale haute
  al_draw_filled_rectangle(rect->x + rect->t, rect->y2 - rect->t, rect->x2 - rect->t, rect->y2, bleuActif); //barre horizontale basse
  al_draw_text(font, bleuActif, elem->rectOptions->x + 11, rect->y, 0, "PAUSE");
  ...
  al_draw_filled_rectangle(rect->x + rect->t, rect->y, rect->x2 - rect->t, rect->y + rect->t, bleuActif); //barre horizontale haute
  al_draw_filled_rectangle(rect->x + rect->t, rect->y2 - rect->t, rect->x2 - rect->t, rect->y2, bleuActif); //barre horizontale basse
  al_draw_text(font, bleuActif, elem->rectOptions->x + 11, rect->y, 0, "PIECE FANTOME");
  ...
  al_draw_filled_rectangle(rect->x + rect->t, rect->y, rect->x2 - rect->t, rect->y + rect->t, bleuActif); //barre horizontale haute
  al_draw_filled_rectangle(rect->x + rect->t, rect->y2 - rect->t, rect->x2 - rect->t, rect->y2, bleuActif); //barre horizontale basse
  al_draw_text(font, bleuActif, elem->rectOptions->x + 11, rect->y, 0, "PIECE SUIVANTE");
  ...
  al_draw_filled_rectangle(rect->x + rect->t, rect->y, rect->x2 - rect->t, rect->y + rect->t, bleuActif); //barre horizontale haute
  al_draw_filled_rectangle(rect->x + rect->t, rect->y2 - rect->t, rect->x2 - rect->t, rect->y2, bleuActif); //barre horizontale basse
  al_draw_text(font, bleuActif, elem->rectOptions->x + 11, rect->y, 0, "VOLUME DU THEME");
  ...
  al_draw_filled_rectangle(rect->x + rect->t, rect->y, rect->x2 - rect->t, rect->y + rect->t, bleuActif); //barre horizontale haute
  al_draw_filled_rectangle(rect->x + rect->t, rect->y2 - rect->t, rect->x2 - rect->t, rect->y2, bleuActif); //barre horizontale basse
  al_draw_text(font, bleuActif, elem->rectOptions->x + 11, rect->y, 0, "VOLUME DES FX");
...
ALLEGRO_BITMAP *genererFondInputOptions(elements *elem, ALLEGRO_BITMAP *fondPrecedent)
{
  ...
  ALLEGRO_COLOR bleuActif = al_map_rgb(104, 120, 166); //couleur de la partie active de la fenêtre
  ALLEGRO_COLOR bleuFond = al_map_rgb(206, 224, 245); //couleur de fond
  ALLEGRO_FONT *font = al_load_ttf_font("media_files/Raleway-Bold.ttf", 15, 0); //on charge la police "Raleway"
...
ALLEGRO_BITMAP *genererBoutonOptions(int typeDeBouton, int onOff, elements *elem, int keyMap[16][3])
{
  ...
  switch(typeDeBouton)
  {
    ...
    case IROTATER:
      ...
      al_set_target_bitmap(bouton); //on cible l'image du bouton pour dessiner dessus
      al_clear_to_color(couleurDeFond); //on remplie par la couleur déterminée au-dessus
      font = al_load_ttf_font("media_files/Raleway-Bold.ttf", 15, 0); //on charge la police "Raleway-Bold"
    ...
    case VOLTHEMEM:
      ...
      al_set_target_bitmap(bouton); //on cible l'image du bouton pour dessiner dessus
      al_clear_to_color(couleurDeFond); //on remplie par la couleur déterminée au-dessus
      font = al_load_ttf_font("media_files/Gameplay.ttf", 15, 0); //on charge la police "Raleway-Bold"
...
ALLEGRO_BITMAP *genererBoutonInputOptions(int typeDeBouton, int onOff, elements *elem)
{
  //on crée un pointeur vers l'image qu'on va renvoyer
  ALLEGRO_BITMAP *bouton = NULL;
...
packTempsInput *genererPackTempsInput(ALLEGRO_BITMAP *fondPrecedent, elements *elem, int temps)
{
  packTempsInput *images = malloc(sizeof(packTempsInput));

  images->fond = genererFondTempsInput(fondPrecedent, elem, temps);
  images->boutonOkOff = genererBoutonOk(OFF, elem->rectBSTLOk);
  images->boutonOkOn = genererBoutonOk(ON, elem->rectBSTLOk);
...
ALLEGRO_BITMAP *genererFondTempsInput(ALLEGRO_BITMAP *fondPrecedent, elements *elem, int temps)
{
  ALLEGRO_BITMAP *fond = al_create_bitmap(SCREEN_W, SCREEN_H); //on crée l'image de fond
  al_set_target_bitmap(fond); //on cible l'image créée
  al_draw_bitmap(fondPrecedent, 0, 0, 0); //on copie l'écran de fin de partie
...
packLignesInput *genererPackLignesInput(ALLEGRO_BITMAP *fondPrecedent, elements *elem, int lignes)
{
  packLignesInput *images = malloc(sizeof(packLignesInput));

  images->fond = genererFondLignesInput(fondPrecedent, elem, lignes);
  images->boutonOkOff = genererBoutonOk(OFF, elem->rectBSTLOk);
  images->boutonOkOn = genererBoutonOk(ON, elem->rectBSTLOk);
...
ALLEGRO_BITMAP *genererFondLignesInput(ALLEGRO_BITMAP *fondPrecedent, elements *elem, int lignes)
{
  ALLEGRO_BITMAP *fond = al_create_bitmap(SCREEN_W, SCREEN_H); //on crée l'image de fond
  al_set_target_bitmap(fond); //on cible l'image créée
  al_draw_bitmap(fondPrecedent, 0, 0, 0); //on copie l'écran de fin de partie
...
void genererBande(ALLEGRO_BITMAP *bande)
{
  al_set_target_bitmap(bande);
  ...
  ALLEGRO_COLOR bleuLignes = al_map_rgb(190, 208, 232); //on crée une nuance de bleu
  int x = 0, x2 = 4, y = 8, y2 = 0;
  for(y; y <= al_get_bitmap_height(bande); y+=8)
  {
    al_draw_line(x, y, x2, y2, bleuLignes, 1.5);
    x2+=4;
  }
  for(x2; x2 <= al_get_bitmap_width(bande); x2+=4)
  {
    al_draw_line(x, y, x2, y2, bleuLignes, 1.5);
    x+=4;
  }
  for(y2; y2 <= al_get_bitmap_height(bande); y2+=8)
  {
    al_draw_line(x, y, x2, y2, bleuLignes, 1.5);
    x+=4;
  }
