...
void highLignes(gameScreen *screen, int lignes, elements *elem)
{
  ...
  if(place) //si le nouveau lignes est supérieur à l'un de ceux du top (si place != 0)
  {
    ...
    lignesInput(screen, joueur, lignes, elem); //le joueur rentre son nom (et le panneau de lignes est affiché)
...
void lignesInput(gameScreen *screen, char joueur[4], int lignes, elements *elem)
{
...
void afficherLignesInput(gameScreen *screen, packLignesInput *images, elements *elem, int boutonOk, char joueur[4])
{
