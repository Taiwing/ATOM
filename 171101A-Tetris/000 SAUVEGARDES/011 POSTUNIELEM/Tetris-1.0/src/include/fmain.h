...
void chargerListeElemFondMenu(gameScreen *screen, elements *elem, Liste *lElem); //va charger la liste pour la fonction "estSurUnBouton"
int estSurUnBouton(Liste *lElem, int x, int y, int modeDeJeu); //vérifie si la souris est sur un bouton
void afficherMenuPrincipal(gameScreen *screen, packMenu *images, elements *elem, int boutonOn, int niveau, int modeDeJeu); //va afficher le menu principal
