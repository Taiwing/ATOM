...
typedef struct elements elements; //48
struct elements
{
  //éléments globaux
  ...
  coord *rectBOptionsResMin;
  coord *rectBOptionsResMax;
  coord *rectBOptionsAppliquer;
  ...
  coord *rectIOptionsResW;
  coord *rectIOptionsResH;
  //Input Options
