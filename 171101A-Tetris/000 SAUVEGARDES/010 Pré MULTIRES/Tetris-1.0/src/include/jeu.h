...
void gameInput(gameData *data, gameScreen *screen, elementsFondPartie *elem, packPartie *images, ALLEGRO_EVENT_QUEUE *event_queue_partie, ALLEGRO_TIMER *timer_partieMarathon, packSons *sons, gameConfig *config);
...
void afficherEvenement(gameData *data, elementsFondPartie *elem); //va afficher l'évènement
