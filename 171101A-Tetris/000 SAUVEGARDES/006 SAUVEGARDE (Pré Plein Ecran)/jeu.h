...
void gameInput(gameData *data, gameScreen *screen, elementsFondPartie *elem, packPartie *images, ALLEGRO_TIMER *timer_partieMarathon, packSons *sons, gameConfig *config);
