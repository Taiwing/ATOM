...
typedef struct elementsFondOptions elementsFondOptions;
...
typedef struct elementsFondTempsInput elementsFondTempsInput;
...
packTempsInput *genererPackTempsInput(ALLEGRO_DISPLAY *fenetre, elementsFondTempsInput *elem, int temps); //va générer le pack d'images de tempsInput
void destroyPackTempsInput(packTempsInput *images); //va détruire la structure d'images de tempsInput
ALLEGRO_BITMAP *genererFondTempsInput(ALLEGRO_DISPLAY *fenetre, elementsFondTempsInput *elem, int temps); //va générer le fond de tempsInput

//structure d'éléments de lignesInput
typedef struct elementsFondLignesInput elementsFondLignesInput;
...
packLignesInput *genererPackLignesInput(ALLEGRO_DISPLAY *fenetre, elementsFondLignesInput *elem, int lignes); //va générer le pack d'images de lignesInput
void destroyPackLignesInput(packLignesInput *images); //va détruire la structure d'images de lignesInput
ALLEGRO_BITMAP *genererFondLignesInput(ALLEGRO_DISPLAY *fenetre, elementsFondLignesInput *elem, int lignes); //va générer le fond de lignesInput
