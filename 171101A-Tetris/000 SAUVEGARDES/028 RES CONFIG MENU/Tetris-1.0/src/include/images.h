...
struct packOptions
{
  ...
  ALLEGRO_BITMAP *inputResWOff;
  ALLEGRO_BITMAP *inputResWOn;
  ALLEGRO_BITMAP *inputResHOff;
  ALLEGRO_BITMAP *inputResHOn;
  ...
  ALLEGRO_BITMAP *boutonResMinOff;
  ALLEGRO_BITMAP *boutonResMinOn;
  ALLEGRO_BITMAP *boutonResMaxOff;
  ALLEGRO_BITMAP *boutonResMaxOn;
  ALLEGRO_BITMAP *boutonAppliquerOff;
  ALLEGRO_BITMAP *boutonAppliquerOn;
