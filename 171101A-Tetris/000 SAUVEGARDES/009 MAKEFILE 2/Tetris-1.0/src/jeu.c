...
void afficherTroisDeuxUn(gameScreen *screen, packPartie *images, elementsFondPartie *elem, int pause, int niveau, int score, int lignes, int temps)
{
  ...
  if(pause == 1) //si on sort de la pause, alors on affiche aussi les données NSL
  {
    ...
    font = al_load_ttf_font("media_files/Gameplay.ttf", 25, 0); //on charge la police "Gameplay" en taille 25
  ...
  font = al_load_ttf_font("media_files/Gameplay.ttf", 50, 0); //on recharge la police Gameplay en taille 50 cette fois
  rect = elem->rectPause;
