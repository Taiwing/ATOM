...
packScoreInput *genererPackScoreInput(ALLEGRO_BITMAP *fondPrecedent, elementsFondScoreInput *elem, int score)
{
...
ALLEGRO_BITMAP *genererFondScoreInput(ALLEGRO_BITMAP *fondPrecedent, elementsFondScoreInput *elem, int score)
{
...
packTempsInput *genererPackTempsInput(ALLEGRO_BITMAP *fondPrecedent, elementsFondTempsInput *elem, int temps)
{
...
ALLEGRO_BITMAP *genererFondTempsInput(ALLEGRO_BITMAP *fondPrecedent, elementsFondTempsInput *elem, int temps)
{
  ALLEGRO_BITMAP *fond = al_create_bitmap(SCREEN_W, SCREEN_H); //on crée l'image de fond
  al_set_target_bitmap(fond); //on cible l'image créée
  al_draw_bitmap(fondPrecedent, 0, 0, 0); //on copie l'écran de fin de partie
...
packLignesInput *genererPackLignesInput(ALLEGRO_BITMAP *fondPrecedent, elementsFondLignesInput *elem, int lignes)
{
...
ALLEGRO_BITMAP *genererFondLignesInput(ALLEGRO_BITMAP *fondPrecedent, elementsFondLignesInput *elem, int lignes)
{
  ALLEGRO_BITMAP *fond = al_create_bitmap(SCREEN_W, SCREEN_H); //on crée l'image de fond
  al_set_target_bitmap(fond); //on cible l'image créée
  al_draw_bitmap(fondPrecedent, 0, 0, 0); //on copie l'écran de fin de partie
