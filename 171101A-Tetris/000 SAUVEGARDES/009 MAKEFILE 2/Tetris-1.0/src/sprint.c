...
void partieSprint(gameScreen *screen, int niveauChoisi, gameConfig *config, packSons *sons)
{
  ...
  if(data->victoire) //si le joueur a gagné
    highTemps(screen, timerSprint); //on va sauvegarder les meilleurs temps comme pour les scores de marathon
...
void afficherPartieSprint(gameScreen *screen, packPartie *images, elementsFondPartie *elem, gameData *data, int timerSprint)
{
