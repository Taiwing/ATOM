...
elementsFondMenu *genererElementsFondMenu()
{
  ...
  //rectOptions
  elem->rectOptions->y = 493; //coordonnée y du point d'origine
  elem->rectOptions->x = 231; //coordonnée x du point d'origine
  elem->rectOptions->x2 = 326; //coordonnée x du point de fin
  elem->rectOptions->y2 = 553; //coordonnée y du point de fin
...
packOptions *genererPackOptions(elementsFondOptions *elem, ALLEGRO_BITMAP *fondPrecedent, int keyMap[9][3])
{
  //on crée un pointeur vers la structure d'images
...
void strTouche(int typeDeBouton, int keyMap[9][3], char str[40])
{
  int touche[3];
