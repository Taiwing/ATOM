...
struct gameData
{
  ...
  bool key[9]; //gestion de l'input clavier
  bool perdu;
  bool victoire;
  bool nextTetro;
  bool legalInput;
...
//fonctions de jeu
void partie(ALLEGRO_DISPLAY *fenetre, int niveauChoisi, gameConfig *config, packSons *sons); //lance une partie de TETRIS au niveau sélectionné
