...
void menuPrincipal()
{
  ...
  resizeElements(elem, screen->scale); //on teste la fonction
  ...
  packOptions *images2 = genererPackOptions(elem, images->fondMenu, config->keyMap);
        ...
        switch(bouton)
        {
            ...
            if(ev.mouse.button & 1) //s'il y a un clic gauche sur ce bouton
            {
              switch(modeDeJeu)
              {
                case MARATHON:
                  ...
                  partieMarathon(screen, niveau, config, sons, elem); //on lance la partie
                  al_install_mouse();
                  ...
                  images2 = genererPackOptions(elem, images->fondMenu, config->keyMap);
                  break;
                case SPRINT:
                  al_uninstall_mouse();
                  al_unregister_event_source(event_queue_menu, al_get_keyboard_event_source()); //puis on reprind les évènements du clavier en compte
                  partieSprint(screen, niveau, config, sons, elem); //on lance la partie
                  al_install_mouse();
                  al_register_event_source(event_queue_menu, al_get_mouse_event_source()); //puis on reprend les évènements de la souris en compte
                  al_register_event_source(event_queue_menu, al_get_keyboard_event_source()); //puis on reprind les évènements du clavier en compte
                ...
                case ULTRA:
                  al_uninstall_mouse();
                  al_unregister_event_source(event_queue_menu, al_get_keyboard_event_source()); //puis on reprind les évènements du clavier en compte
                  partieUltra(screen, niveau, config, sons, elem); //on lance la partie
                  al_install_mouse();
                  al_register_event_source(event_queue_menu, al_get_mouse_event_source()); //puis on reprend les évènements de la souris en compte
                  al_register_event_source(event_queue_menu, al_get_keyboard_event_source()); //puis on reprind les évènements du clavier en compte
                  //puis on recharge l'image du highScore
          ...
          case AIDE:
            if(ev.mouse.button & 1) //s'il y a un clic gauche sur ce bouton
            {
              ...
              menuAide(screen, images->fondMenuAide, images->boutonOkOn, images->boutonOkOff, elem->rectAide, elem->rectBAideOk, elem->rectNSL, 0, 0, 0);
              al_install_mouse();
              al_register_event_source(event_queue_menu, al_get_mouse_event_source()); //puis on reprend les évènements de la souris en compte
          ...
          case OPTIONS:
            if(ev.mouse.button & 1) //s'il y a un clic gauche sur ce bouton
            {
              al_uninstall_mouse();
              al_unregister_event_source(event_queue_menu, al_get_keyboard_event_source());
              menuOptions(screen, config, elem, images2, sons);
              al_install_mouse();
              al_register_event_source(event_queue_menu, al_get_mouse_event_source()); //puis on reprend les évènements de la souris en compte
              al_register_event_source(event_queue_menu, al_get_keyboard_event_source()); //puis on reprend les évènements du clavier en compte
              //on régénère le pack options pour afficher les changements s'il y en a eu
              images2 = genererPackOptions(elem, screen->buffer, config->keyMap);
            }
            break;
        }
      }
